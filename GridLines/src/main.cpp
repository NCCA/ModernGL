...
int main()
{
  ...
  SDL_Window *window=SDL_CreateWindow("SDL2 OpenGL4.x GridLines",
  ...
  // create the triangle
auto [vaoID,nVerts]=createGrid(10.0f,10.0f,20,12);
...
void main()
{
  ...
  while(!quit)
  {
    ...
    glDrawArrays(GL_LINES, 0, numToDraw);	// draw object
